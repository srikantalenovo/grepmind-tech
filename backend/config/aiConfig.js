export const AI_CONFIG = {
  ...
  models: {
    chat: {
      name: 'Qwen3-Embedding-0.6B-Q8_0.gguf',  // Lightweight conversational model
      type: 'conversational',
      maxTokens: 150,
      temperature: 0.7,
      description: 'Lightweight conversational model for chat widget',
      modelPath: './models/chat/',  // Local file path
      ollamaModel: 'Qwen3-Embedding-0.6B-Q8_0.gguf',     // Ollama model name
